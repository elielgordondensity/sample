    ...
    <Card onPress={handlePress}>
      <View style={styles.header}>
        <View style={styles.identifierRow}>
          <View style={[styles.identifierIcon, { backgroundColor: themeColors.backgroundTertiary }]}>
            <HashIcon width={14} height={14} color={themeColors.textSecondary} />
          </View>
          <Typography
            type="header"
            fontSize={14}
      ...
      <View style={styles.details}>
        ...
        {device.deployment_group?.platform && (
          <DetailRow
            label="Platform"
            value={device.deployment_group.platform}
          />
        )}
      </View>
